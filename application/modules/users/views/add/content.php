...
echo base_url("users/save"); ?>" method="post">
                    <?php echo form_hidden($this->security->get_csrf_token_name(), $this->security->get_csrf_hash()); ?>

                    <div class="form-group">
                        <label>Kullanıcı Adı</label>
                        <input class="form-control" placeholder="Kullanıcı Adı" name="user_name" value="<?php echo isset($form_error) ? safe_attr(set_value("user_name")) : ""; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Ad Soyad" name="full_name" value="<?php echo isset($form_error) ? safe_attr(set_value("full_name")) : ""; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="email" placeholder="E-posta Adresi" name="email" value="<?php echo isset($form_error) ? safe_attr(set_value("email")) : ""; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="user_role_id" class="form-control">
                            <?php foreach($user_roles as $user_role) { ?>
                                <option value="<?php echo safe_attr($user_role->id); ?>"><?php echo safe_output($user_role->title); ?></option>
                            <?php } ?>
                        </select>
                        <?php if(isset($form_error)){ ?>
