                    ...
                    <div class="form-group">
                        ...
                        <select name="main_id" class="form-control">
                            <?php foreach ($categories as $category) { ?>
                                ...
                                <option <?php echo ($category->id === $main_id) ? "selected" : ""; ?> value="<?php echo safe_attr($category->id); ?>"><?php echo safe_output($category->title); ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="proses_id" class="form-control">
                            <?php foreach ($categories as $category) { ?>
                                ...
                                <option <?php echo ($category->id === $proses_id) ? "selected" : ""; ?> value="<?php echo safe_attr($category->id); ?>"><?php echo safe_output($category->title); ?></option>
                            <?php } ?>
                        </select>
