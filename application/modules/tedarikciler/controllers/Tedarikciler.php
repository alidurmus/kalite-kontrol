...
class Tedarikciler extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = base_url('tedarikciler/index');
        $config['total_rows'] = $this->tedarikciler_model->get_count($where);
        $config['per_page'] = 20;
        ...
        $items = $this->tedarikciler_model->get_limit(
            $where,
            $config['per_page'],
            $page
        );
    ...
    public function update($id)
    {
        ...
        if ($validate) {
            ...
            $update = $this->tedarikciler_model->update(['id' => $id], $data);
