...
<?php } else { ?>
    ...
    <table class="table table-bordered table-striped table-hover pictures_list">
        ...
        <?php foreach($item_images as $image){ ?>
            ...
            <tr id="ord-<?php echo safe_output($image->id); ?>">
                <td class="order"><i class="fa fa-reorder"></i></td>
                <td class="w50 text-center">#<?php echo safe_output($image->id); ?></td>
                <td class="w100 text-center">
                    <img width="30"
                         src="<?php echo get_picture($viewFolder, $image->img_url, "348x215"); ?>"
                         alt="<?php echo safe_output($image->img_url); ?>"
                         class="img-responsive">
                </td>
                <td><?php echo safe_output($image->img_url); ?></td>
                <td class="w100 text-center">
                    <input
                ...
                <td class="w100 text-center">
                    <button
                        data-url="<?php echo base_url("products/imageDelete/$image->id/$image->product_id"); ?>"
