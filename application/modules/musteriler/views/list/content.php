    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("musteriler/index"); ?>" method="get">
                    <div class="row">
                        <div class="form-group col-md-5">
                            <label for="search_title">Müşteri Adı</label>
                            <input type="text" name="search_title" class="form-control" placeholder="Müşteri adı..." value="<?php echo safe_attr($search_title); ?>">
                        </div>
                        <div class="form-group col-md-5">
                            <label for="search_sorumlu">Sorumlu</label>
                            <input type="text" name="search_sorumlu" class="form-control" placeholder="Sorumlu..." value="<?php echo safe_attr($search_sorumlu); ?>">
                        </div>
                        <div class="form-group col-md-2 d-flex align-items-end">
                            <button type="submit" class="btn btn-primary mr-2 w-100">Ara</button>
                            <a href="<?php echo base_url("musteriler"); ?>" class="btn btn-outline-secondary w-100">Temizle</a>
                        </div>
                    </div>
                </form>
            </div>
