<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            ...
            <?php   if(isAllowedWriteModule()){ ?>
                <a href="<?php echo base_url("ajax/new_form"); ?>" class="btn btn-outline btn-primary btn-xs pull-right"> <i class="fa fa-plus"></i> Yeni Ekle</a>
            <?php } ?>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
    ...
    $(document).on('click', '#add', function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>ajax/insert",
            type: "post",
            dataType: "json",
            data: {
                name: name,
    ...
    $(document).on("click", "#edit", function(e) {
        ...
        if (edit_id == "") {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>ajax/edit",
                type: "post",
                dataType: "json",
                data: {
                    edit_id: edit_id
