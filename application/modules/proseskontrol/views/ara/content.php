...
echo base_url("anasayfa/kalite"); ?>" class="btn btn-primary  btn-lg"><-- Kalite</a>
        ...
        <div class="col-md-12">
            ...
            <form method="post" action="<?= base_url() ?>proseskontrol/search/">
                <input type="text" name="search" value="<?php echo safe_attr($search_text); ?>"><input type="submit" name="submit">
            </form>
            <br />
                ...
                <tbody class="sortable" data-url="<?php echo base_url("proseskontrol/rankSetter"); ?>">
                    <?php foreach ($items as $item) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url("anasayfa/proseskontrol_duzenle"); ?>/<?php echo safe_output($item->id); ?>" class="btn btn-info">Düzenle</a>
