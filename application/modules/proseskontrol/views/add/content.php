...
echo base_url("proseskontrol/save"); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div id="control-demo-6" class="">
                            <select class="form-control news_type_select" name="malzeme">  
                                <?php foreach($malzemeler as $malzeme) { ?>
                                    <option value="<?php echo safe_attr($malzeme->id); ?>"><?php echo safe_output($malzeme->adi); ?></option>
                                <?php } ?>                              
                            </select>
                        </div>
                    </div><!-- .form-group -->
                        ...
                        <div id="control-demo-6" class="">
                            <select class="form-control news_type_select" name="kullanici">  
                                <?php foreach($kullanicilar as $kullanici) { ?>
                                    <option value="<?php echo safe_attr($kullanici->id); ?>"><?php echo safe_output($kullanici->adi); ?></option>
                                <?php } ?>                              
                            </select>
                        </div>
                    </div><!-- .form-group -->
