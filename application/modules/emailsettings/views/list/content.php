                    ...
                    <tbody>
                        ...
                        <?php foreach($items as $item) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo safe_output($item->user_name); ?></td>
                                <td class="text-center"><?php echo safe_output($item->host); ?></td>
                                <td class="text-center"><?php echo safe_output($item->protocol); ?></td>
                                <td class="text-center"><?php echo safe_output($item->port); ?></td>
                                <td class="text-center"><?php echo safe_output($item->user); ?></td>
                                <td class="text-center"><?php echo safe_output($item->from); ?></td>
                                <td class="text-center"><?php echo safe_output($item->to); ?></td>
