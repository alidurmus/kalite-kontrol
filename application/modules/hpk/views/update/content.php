...
echo "<b>$item->hpk</b> kaydını düzenliyorsunuz"; ?>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("hpk/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Hpk</label>
                        <input class="form-control" placeholder="Hpk" name="hpk" value="<?php echo safe_attr($item->hpk); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="main_id" name="main_id" value="<?php echo safe_attr($item->main_id); ?>">
                        <?php if(isset($form_error)){ ?>
                            ...
                            <select name="category_id" class="form-control">
                                <?php foreach($categories as $category) { ?>
                                    ...
                                    <option
                                        ...
                                        value="<?php echo safe_attr($category->id); ?>"><?php echo safe_output($category->title); ?></option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="form-group">
                        <label>Ana İşlem</label>
                        <input class="form-control" placeholder="proses" name="proses" value="<?php echo safe_attr($item->proses); ?>">
                        <?php if(isset($form_error)){ ?>
