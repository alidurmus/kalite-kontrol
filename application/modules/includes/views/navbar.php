    ...
    <div class="navbar-header">
        ...
        <a href="<?php echo base_url("dashboard"); ?>" class="navbar-brand">
            <span class="brand-icon">
                ...
                <?php if(isset($settings->logo) && $settings->logo != "default"){ ?>
                    <img
                        width="70"
                        src="<?php echo base_url("uploads/settings_v/150x35/" . $settings->logo); ?>"
                        alt=""
            ...
            <span class="brand-name">
                <?php echo isset($settings->company_name) ? $settings->company_name : 'Kalite Yönetim Sistemi'; ?>
            </span>
        </a>
    </div><!-- .navbar-header -->
