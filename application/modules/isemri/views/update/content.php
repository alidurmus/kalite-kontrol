        ...
        <div class="widget">
            <div class="widget-body">
                ...
                <div class="form-group col-md-6">
                        <label>lot</label>
                        <input class="form-control" placeholder="lot" name="lot" value="<?php echo safe_attr($item->lot); ?>"> 
                    ...
                    <div class="form-group col-md-6">
                        <label>musteri</label>
                        <input class="form-control" placeholder="musteri" name="musteri" value="<?php echo safe_attr($item->musteri); ?>">                        
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" placeholder="siparis_no" name="siparis_no" value="<?php echo safe_attr($item->siparis_no); ?>">                        
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" placeholder="uretim_tarihi" name="uretim_tarihi" value="<?php echo safe_attr($item->uretim_tarihi); ?>">                        
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" placeholder="sevk_tarihi" name="sevk_tarihi" value="<?php echo safe_attr($item->sevk_tarihi); ?>">                        
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group col-md-6">
                        <label>Tarih</label>
                        <input type="date" class="form-control" placeholder="tarih" name="tarih" value="<?php echo safe_attr($item->tarih); ?>">                        
                        <?php if(isset($form_error)){ ?>
                                        ...
                                        <?php // echo $row . ' - ' .$key . ': ' . $val; ?>   
                                            <td>
                                                <div class="input-group"> 
                                                    <input  type="text" class="form-control input-sm" value="<?php echo safe_attr($val); ?>" name="form[isemri][<?php echo safe_output($row); ?>][<?php echo safe_output($key); ?>]" > 
                                                </div>
                                            </td>                                        
                                    <?php } ?>
                                    </tr> 
