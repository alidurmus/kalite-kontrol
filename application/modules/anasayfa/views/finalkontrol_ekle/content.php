...
echo base_url("anasayfa/finalkontrol_kaydet"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="input-group">
                                <input readonly type="text" name="urun_adi" class="form-control input-sm" value="<?php echo safe_attr($urun->adi); ?>" placeholder="urun">
                            </div>
                        </td>
                        <td></td>
            ...
            <input type="hidden" name="urun" class="form-control input-sm" value="<?php echo safe_attr($urun->id); ?>">
