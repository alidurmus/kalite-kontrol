<div class="row">
    ...
    <div class="col-md-12">
        <form id="kontrolForm" action="<?php 
// Load security helper for XSS protection
$this->load->helper('security');
echo base_url("anasayfa/girdikontrol_kaydet"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="input-group">
                                <input readonly type="text"  name="malzeme_adi" required class="form-control input-sm required" value="<?php echo safe_attr($malzeme->adi); ?>" placeholder="malzeme"> 
                            </div>                            
                        </td>
                        <td></td>
                            ...
                            <div class="form-group">  
                                <select name="tedarikci" class="form-control">                               
                                    <?php foreach($tedarikciler as $tedarikci) { ?>                                       
                                        <option value="<?php echo safe_attr($tedarikci->id); ?>"><?php echo safe_output($tedarikci->adi); ?></option>
                                    <?php } ?>
                                </select>      
                            </div><!-- .form-group -->                            
                        </td>
            ...
            <input   type="hidden" name="kullanici" class="form-control input-sm"  value="<?php echo safe_attr($user->id); ?>" />
