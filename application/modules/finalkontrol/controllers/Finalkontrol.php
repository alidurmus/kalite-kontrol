...
class Finalkontrol extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $search_kutu = $this->input->get('search_kutu');
        ...
        if ($search_kutu) {
            $where['kutu_no LIKE'] = '%' . $search_kutu . '%';
        }
        if ($search_lot) {
        ...
        $config = [];
        $config['base_url'] = base_url('finalkontrol/index');
        $config['total_rows'] = $this->final_kontrol_model->get_count($where);
        $config['per_page'] = 100;
        ...
        $items = $this->final_kontrol_model->get_limit(
            $where,
            $config['per_page'],
            $page
        );
        ...
        $viewData->search_kutu = $search_kutu;
    ...
    public function search($search_text = '')
    {
        ...
        $items = $this->final_kontrol_model->getSearch([], $search_text);
    ...
    public function update($id)
    {
        ...
        if ($validate) {
            ...
            $update = $this->final_kontrol_model->update(['id' => $id], $data);
