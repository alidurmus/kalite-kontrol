        ...
        <div class="widget">
            <div class="widget-body">
                ...
                <div class="form-group">
                        ...
                        <input readonly="readonly" class="form-control" placeholder="kontrol_no" name="kontrol_no" value="<?php echo safe_attr($item->kontrol_no); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="parti_no" name="parti_no" value="<?php echo safe_attr($item->parti_no); ?>">
                        <?php if(isset($form_error)){ ?>
                            ...
                            <select name="tedarikci" class="form-control">                               
                                    <?php foreach($tedarikciler as $tedarikci) { ?>
                                        ...
                                        <option
                                            ...
                                            value="<?php echo safe_attr($tedarikci->id); ?>"><?php echo safe_output($tedarikci->adi); ?></option>
                                    <?php } ?>
                            </select>
                                <?php if(isset($form_error)){ ?>
                            ...
                            <select name="malzeme" class="form-control">                               
                                    <?php foreach($malzemeler as $malzeme) { ?>
                                        ...
                                        <option
                                            ...
                                            value="<?php echo safe_attr($malzeme->id); ?>"><?php echo safe_output($malzeme->adi); ?></option>
                                    <?php } ?>
                             </select>
                            ...
                            <select name="kullanici" class="form-control">               
                                    <?php foreach($kullanicilar as $kullanici) { ?>
                                        ...
                                        <option
                                            ...
                                            value="<?php echo safe_attr($kullanici->id); ?>"><?php echo safe_output($kullanici->adi); ?></option>
                                    <?php } ?>
                             </select>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="irsaliye" name="irsaliye"  value="<?php echo safe_attr($item->irsaliye); ?>">                        
                    </div>
                    <div class="form-group">
                        <label>Tarih</label>
                        <input class="form-control" placeholder="tarih" name="tarih" value="<?php echo safe_attr($item->tarih); ?>">                        
                    </div>
                    <div class="form-group">
                                            ...
                                            <td>
                                                    <div class="input-group"> 
                                                        <?php if($key == "olcum" || $key == "sonuc" ){ ?>  
                                                            <input  type="text" class="form-control input-sm" value="<?php echo safe_attr($val); ?>" name="form[olcum][<?php echo safe_output($row); ?>][<?php echo safe_output($key); ?>]" > 
                                                        <?php }else { ?>
                                            ...
                                            <select name="sonuc" class="form-control">                               
                                                    <?php foreach($sonuc as $sonuc_tek) { ?>
                                                        ...
                                                        <option
                                                            ...
                                                            value="<?php echo safe_attr($sonuc_tek->id); ?>"><?php echo safe_output($sonuc_tek->adi); ?></option>
                                                    <?php } ?>
                                            </select>
