                    ...
                    <tbody class="sortable" data-url="<?php echo base_url("galleries/rankSetter"); ?>">
                        ...
                        <?php foreach($items as $item) { ?>
                            ...
                            <tr id="ord-<?php echo safe_output($item->id); ?>">
                                ...
                                <td class="text-center"><?php echo safe_output($item->title); ?></td>
                                <td class="text-center"><?php echo safe_output($item->gallery_type); ?></td>
                                <td class="text-center"><?php echo safe_output($item->folder_name); ?></td>
                                <td class="text-center"><?php echo safe_output($item->url); ?></td>
                                ...
                                <?php   if(isAllowedDeleteModule()){ ?>
                                    ...
                                    <?php } ?>
                                    <a href="<?php echo base_url($button_url); ?>" class="btn btn-sm btn-dark btn-outline"><i class="fa <?php echo safe_output($button_icon); ?>"></i> Galeriye gözat</a>
                                </td>
                            </tr>
