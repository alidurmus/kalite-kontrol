...
class Galleries extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->viewFolder = 'galleries';

        $this->load->model('galleries/gallery_model');
        $this->load->model('galleries/image_model');
        $this->load->model('galleries/video_model');
        $this->load->model('galleries/file_model');
