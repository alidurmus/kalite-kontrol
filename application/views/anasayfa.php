...
<body>
  <div class="container">
        <div class="row">
            <div class="col-md-12">
				<a href="<?php echo safe_url($yonetim); ?>" class="<?php echo safe_output($css_class);?>">Yönetim</a>
				<a href="<?php echo safe_url($arge); ?>" class="<?php echo safe_output($css_class);?>">Arge</a>
				<a href="<?php echo safe_url($planlama); ?>" class="<?php echo safe_output($css_class);?>">Planlama</a>
				<a href="<?php echo safe_url($kalite); ?>" class="<?php echo safe_output($css_class);?>">Kalite</a>
