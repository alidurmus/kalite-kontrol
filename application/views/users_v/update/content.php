...
echo "<b>$item->user_name</b> kaydını düzenliyorsunuz"; ?>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget">
                    ...
                    <div class="form-group">
                        ...
                        <select name="user_role_id" class="form-control">
                            <?php foreach($user_roles as $user_role) { ?>
                                <option <?php echo ($user_role->id == $item->user_role_id) ? "selected" : ""; ?> value="<?php echo safe_attr($user_role->id); ?>">
                                    <?php echo safe_output($user_role->title); ?>
                                </option>
                            <?php } ?>
                        </select>
                        <?php if(isset($form_error)){ ?>
