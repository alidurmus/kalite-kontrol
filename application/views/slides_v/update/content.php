...
echo "<b>$item->title</b> kaydını düzenliyorsunuz"; ?>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("slides/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Başlık</label>
                        <input class="form-control" placeholder="Başlık" name="title" value="<?php echo safe_attr($item->title); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="m-0" data-plugin="summernote" data-options="{height: 250}"><?php echo safe_output($item->description); ?></textarea>
                    </div>
                    ...
                    <div class="button-information-container" style="display : <?php echo ($item->allowButton) ? "block" : "none"; ?>">
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Butonun üzerindeki yazı" name="button_caption" value="<?php echo safe_attr($item->button_caption); ?>">
                            <?php if(isset($form_error)){ ?>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Butona basıldığında gidilecek olan URL Bilgisi" name="button_url" value="<?php echo safe_attr($item->button_url); ?>">
                            <?php if(isset($form_error)){ ?>
