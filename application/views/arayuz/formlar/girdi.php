            ...
            <table class="table table-striped table-sm"> 
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="input-group"> 
                                            <input type="text" class="form-control" name="form[olcum][k<?php echo safe_output($i); ?>][adi]" placeholder="Username"> 
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group"> 
                                            <input type="number" class="form-control" name="form[olcum][k<?php echo safe_output($i); ?>][olcu]" placeholder="Username"> 
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group"> 
                                            <input type="number" class="form-control" name="form[olcum][k<?php echo safe_output($i); ?>][tolerans]" placeholder="Username"> 
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group"> 
                                            <input type="number" class="form-control" name="form[olcum][k<?php echo safe_output($i); ?>][alt_limit]" placeholder="Username"> 
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group"> 
                                            <input type="number" class="form-control" name="form[olcum][k<?php echo safe_output($i); ?>][ust_limit]" placeholder="Username"> 
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group"> 
                                            <input type="number" class="form-control" name="form[olcum][k<?php echo safe_output($i); ?>][olcum]" placeholder="Username"> 
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group"> 
                                            <input type="text" class="form-control" name="form[olcum][k<?php echo safe_output($i); ?>][sonuc]" placeholder="Username"> 
                                        </div>
                                    </td>
                                    <td>
                                    <div class="input-group"> 
                                            <input type="text" class="form-control" name="form[olcum][k<?php echo safe_output($i); ?>][kontrol_noktasi]" placeholder="Username"> 
                                        </div>
                                    </td>
                                    <td> 
                                        <input class="form-check-input" type="radio" name="form[olcum][k<?php echo safe_output($i); ?>][gorsel]" value="1">
                                    </td>
                                    <td> 
                                        <input class="form-check-input" type="radio" name="form[olcum][k<?php echo safe_output($i); ?>][gorsel]" value="2">
                                    </td>
                                    <td> 
                                        <input class="form-check-input" type="radio" name="form[olcum][k<?php echo safe_output($i); ?>][gorsel]" value="3">
                                    </td>
                                </tr>  
                                <?php } ?>   
