            ...
            <div class="col-md-12">
                <table id="dataTable" class="table table-hover table-striped table-bordered content-container">
                    ...
                    <?php foreach($formlar as $form) { ?>
                        <tr>
                            <td><?php echo safe_output($form->malzeme_adi); ?></td>
                            <td><?php echo safe_output($form->tedarikci_adi); ?></td>
                            <td><?php echo safe_output($form->kontrol_no); ?></td>
                            <td><?php echo safe_output($form->parti_no); ?></td>
                            <td><?php echo safe_output($form->irsaliye); ?></td>
                            <td><?php echo safe_output($form->tarih); ?></td>
                            <td>
                                <a href="<?php echo base_url("index.php/arayuz/girdi_guncelle"); ?>?form_id=<?php echo safe_output($form->id);?>" class="btn btn-info">Düzenle</a>
