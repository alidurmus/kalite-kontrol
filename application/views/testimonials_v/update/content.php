            ...
            <div class="widget-body">
                <form action="<?php echo base_url("testimonials/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Ad Soyad" name="full_name" value="<?php echo safe_attr($item->full_name); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Şirket Adı" name="company" value="<?php echo safe_attr($item->company); ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" placeholder="Bizimle ilgili mesaj..." cols="30" rows="10"><?php echo safe_output($item->description); ?></textarea>
                        <?php if(isset($form_error)){ ?>
