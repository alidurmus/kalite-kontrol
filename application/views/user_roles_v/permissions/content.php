                ...
                <form action="<?php echo base_url("user_roles/update_permissions/$item->id"); ?>" method="post">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <?php foreach (getControllerList() as $controllerName) { ?>
                                <tr>
                                    <td><?php echo safe_output($controllerName); ?></td>
                                    <td class="w50 text-center">
                                        <input
                                                <?php echo (isset($permissions->$controllerName) && isset($permissions->$controllerName->read)) ? "checked" : ""; ?>
                                                name="permissions[<?php echo safe_output($controllerName); ?>][read]" type="checkbox" data-switchery data-color="#10c469"/>
                                    </td>
                                    <td class="w50 text-center">
                                        <input
                                                <?php echo (isset($permissions->$controllerName) && isset($permissions->$controllerName->write)) ? "checked" : ""; ?>
                                                name="permissions[<?php echo safe_output($controllerName); ?>][write]" type="checkbox" data-switchery data-color="#10c469"/>
                                    </td>
                                    <td class="w50 text-center">
                                        <input
                                                <?php echo (isset($permissions->$controllerName) && isset($permissions->$controllerName->update)) ? "checked" : ""; ?>
                                                name="permissions[<?php echo safe_output($controllerName); ?>][update]" type="checkbox" data-switchery data-color="#10c469"/>
                                    </td>
                                    <td class="w50 text-center">
                                        <input
                                                <?php echo (isset($permissions->$controllerName) && isset($permissions->$controllerName->delete)) ? "checked" : ""; ?>
                                                name="permissions[<?php echo safe_output($controllerName); ?>][delete]" type="checkbox" data-switchery data-color="#10c469"/>
                                    </td>
                                </tr>
                        <?php } ?>
