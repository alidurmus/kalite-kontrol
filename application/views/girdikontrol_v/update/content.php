                    ...
                    <div class="form-group">
                        ...
                        <div id="control-demo-6" class="">                          
                            <select class="form-control news_type_select" name="tedarikci">
                                <option value="<?php echo safe_attr($item->tedarikci); ?>"><?php echo safe_output($item->tedarikci); ?></option>
                                <?php foreach($tedarikciler as $tedarikci2) { ?>
                                    <option value="<?php echo safe_attr($tedarikci2->id); ?>"><?php echo safe_output($tedarikci2->adi); ?></option>
                                <?php } ?>                                     
                            </select>                           
                        </div>
                    </div><!-- .form-group -->
                    <div class="form-group">
                        ...
                        <div id="control-demo-6" class="">                          
                            <select class="form-control news_type_select" name="malzeme">
                                <option value="<?php echo safe_attr($item->malzeme); ?>"><?php echo safe_output($item->malzeme); ?></option>
                                <?php foreach($malzemeler as $malzeme2) { ?>
                                    <option value="<?php echo safe_attr($malzeme2->id); ?>"><?php echo safe_output($malzeme2->adi); ?></option>
                                <?php } ?>                                     
                            </select>                           
                        </div>
                    </div><!-- .form-group -->
